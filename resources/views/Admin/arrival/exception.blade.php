...
@section('page-heading', 'Admitted with exception')
@section('css')
@stop
    ...
    <table class="table table-bordered table-striped datatable">
        <thead>
            <tr>
                ...
                <th>Created</th>
                <th>Admit Entry</th>
                <th>admit with exception reason</th>
                <th>Department</th>
                <th>Zone</th>
                <th>Travel Alone</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $arrivals->afterassessment->freight_company ?? ""}}</td>
                <td>{{$arrivals->afterassessment->driver_name ?? "N/A"}}</td>
                <td>{{$arrivals->afterassessment->driver_mobile ?? "N/A"}}</td>
                <td>{{$arrivals->afterassessment->vehicle_number ?? ""}}</td>
                <td>{{$arrivals->temperature ?? ""}}</td>
                <td>{{$arrivals->afterassessment->countries ?? "N/A"}}</td>
                <td>{{$arrivals->afterassessment->description_of_freight ?? "N/A"}}</td>
                ...
                <td>{{$arrivals->department->name}}</td>
