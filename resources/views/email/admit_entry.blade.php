...
<head>
    ...
    <title>Admit Entry Response | Munster Joinery</title>
</head>
                ...
                max-width: 500px;" class="wrapper">
                    ...
                    <tr>
                        ...
                        font-family: sans-serif;" class="header">
                            Admit Entry with  exception <br>
                            <u>Visitor : {{ $data['driver_name'] }}</u>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
                    ...
                    <tr>
                        ...
                        font-family: sans-serif; justify-content: center;" class="paragraph">
                            <u>{{ $data['driver_name'] }}</u> Was admitted with exception
                            <br>

                            <div style="padding-bottom: 5px;">Visitor Name: <strong style="color: #bbb;font-size: 18px;">{{ $data['driver_name'] ?? ""}}</strong></div>
                            <div style="padding-bottom: 5px;">Temperature: <strong style="color: #bbb;font-size: 18px;">{{$data['arrival']->temperature ?? ""}} </strong></div>
                            <div style="padding-bottom: 5px;">Date: <strong style="color: #bbb;font-size: 18px;">{{$data['arrival']->created_at ?? ""}}</strong></div>
                            <div style="padding-bottom: 5px;">Taste And Smell: <strong style="color: #bbb;font-size: 18px;">{{ $data['arrival']->afterassessment->taste_and_smell ?? "" }}</strong></div>
                            <div style="padding-bottom: 5px;">Close Contact: <strong style="color: #bbb;font-size: 18px;">{{ $data['arrival']->afterassessment->close_contact ?? "" }}</strong></div>
                            <div style="padding-bottom: 5px;">Agree to notify MJ: <strong style="color: #bbb;font-size: 18px;">{{ $data['arrival']->afterassessment->diagnosed_with_Covid ?? "" }}</strong></div>
                            <br>
                            Admin with exception comment : {{$data['arrival']->reason ?? ""}}
                        </td>
                    </tr>
                    <tr>
